...
#Now converting body of text and save it inside of .json file and additional "if-else" statement to find last test using id($2) then remove comma after curly bracket "}"
...
#Converting end of file and store in .json file and "CONVFMT="%.2f"" to round up 2 decimal point
